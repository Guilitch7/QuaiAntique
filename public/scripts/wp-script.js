...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetchInformation('https://www.mcphy.com/wp-json/wp/v2/media', 'dateMcp', 'slugMcp', 'linkMcp', 'sourceMcp');
    fetchInformation('https://www.pharmagest.com/wp-json/wp/v2/media', 'datePha', 'slugPha', 'linkPha', 'sourcePha');
    ...
    fetchInformation('https://www.ses-imagotag.com/wp-json/wp/v2/media', 'dateIma', 'slugIma', 'linkIma', 'sourceIma');
    fetchInformation('https://www.thermador-groupe.com/wp-json/wp/v2/media', 'dateTher', 'slugTher', 'linkTher', 'sourceTher');
    fetchInformation('https://www.valneva.com/wp-json/wp/v2/media', 'dateVal', 'slugVal', 'linkVal', 'sourceVal');
    ...
    fetchInformation('https://www.frey.fr/wp-json/wp/v2/media', 'dateFre', 'slugFre', 'linkFre', 'sourceFre');
    fetchInformation('https://www.infotel.com/wp-json/wp/v2/media', 'dateInf', 'slugInf', 'linkInf', 'sourceInf');
    ...
    fetchInformation('https://www.gerard-perrier.com/wp-json/wp/v2/media', 'dateGer', 'slugGer', 'linkGer', 'sourceGer');
    ...
    fetchInformation('https://www.advini.fr/wp-json/wp/v2/media', 'dateAdvi', 'slugAdvi', 'linkAdvi', 'sourceAdvi');
    ...
    fetchInformation('https://www.orpea-corp.com/wp-json/wp/v2/media', 'dateOrp', 'slugOrp', 'linkOrp', 'sourceOrp');
